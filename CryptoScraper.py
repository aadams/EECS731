...
for x in range(1, 1000):
    if df2['allowance']['remaining'] > 0: 
        ...
        time.sleep(sleep)
dfKA.write('KA.csv', encoding = 'UTF-8', index = False)
dfKB.write('KB.csv', encoding = 'UTF-8', index = False)
dfBA.write('BA.csv', encoding = 'UTF-8', index = False)
dfBB.write('BB.csv', encoding = 'UTF-8', index = False)
